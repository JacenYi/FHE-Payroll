...
export const ENV = {
  // 合约相关
  CONTRACT_ADDRESS: import.meta.env.VITE_CONTRACT_ADDRESS || '0x93********************************EAdAA',
  SALARY_TOKEN_ADDRESS: import.meta.env.VITE_SALARY_TOKEN_ADDRESS || '0x07****************************0091',
  SALARY_ERC20_ADDRESS: import.meta.env.VITE_SALARY_ERC20_ADDRESS || '0xB3*************************************8dE3',
  SWAP_CONTRACT_ADDRESS: import.meta.env.VITE_SWAP_CONTRACT_ADDRESS || '0xd7***********************************2d22',
